...
/**
 * A utility export class to represent the layers selection.
...
/** A utility export class to represent a curve point (with handles to control the curve in a path). */
export class CurvePoint extends Component {
...
/** A utility export class to represent a point. */
...
export class SmartLayoutObject {
...
/** A shape path layer. */
export class ShapePath extends Layer {
    /** returns a wrapped object from a native Sketch model object */
...
/** Wrapper declare classes that are used to represent reusable assets retrieved from a document or globally. */
interface Assets {
    colors: ColorAsset[],
    gradients: GradientAsset[],
}

/** Wrapper declare classes that are used to represent reusable color assets retrieved from a document or globally. */
...
/** Wrapper declare classes that are used to represent reusable gradient assets retrieved from a document or globally. */
